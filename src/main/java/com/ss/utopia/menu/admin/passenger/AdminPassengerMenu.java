package com.ss.utopia.menu.admin.passenger;
...
public class AdminPassengerMenu extends AbstractMenu {
    ...
    protected String getInitialPrompt() {
        ...
        sb.append("Which flight would you like to see passengers for:").append(newLine())
                .append(newLine());
    ...
    public Map<Integer, MenuSelection> getMenuSelections() {
        ...
        for (int i = 0; i < flights.size(); i++) {
            selections.put(i + 1, new PassengersListMenu());
        }
        return selections;
    }
}
